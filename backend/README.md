...
## Project Structure
    ...
    ├── transportation_temp_38081  # Django project configurations
...
1. Clone this repo and `cd transportation_temp_38081`
...
2. Clone this repo and `cd transportation_temp_38081`
